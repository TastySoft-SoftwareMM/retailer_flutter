...
class InventoryStockSearch extends SearchDelegate {
      ...
      children: [
        Container(
          ...
          child: TextButton(
              ...
              child: Row(
                children: [
                  Text(value1, overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: Colors.black,
                      fontSize: 13,
                    ),
        ...
        Container(
          ...
          child: TextButton(
              ...
              child: Row(
                children: [
                  Text(value2, style: TextStyle(color: Colors.black,fontSize: 13,),),
                  Spacer(),
                  Icon(Icons.arrow_drop_down)
                ],
              )
        ...
        Container(
          ...
          child: TextButton(
              ...
              child: Row(
                children: [
                  Text(value3, style: TextStyle(color: Colors.black,fontSize: 13),),
                  Spacer(),
                  Icon(Icons.arrow_drop_down),
                ],
              )
  ...
  Widget getlistView(BuildContext context, getlist) {
    var alertDialog = AlertDialog(
      title: Text("Select Category", style: TextStyle(fontSize: 15),),
      content: Row(
        children: [
          thelist(getlist),
        ],
      ...
      child: ListView.builder(
        ...
        itemBuilder: (BuildContext context, int index) {
          return Container(
            ...
            child: ListTile(
              title: Text(getlist[index],style: TextStyle(fontSize: 14),),

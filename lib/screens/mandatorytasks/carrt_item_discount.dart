   ...
   return Padding(
     ...
     child: custom.ExpansionTitle(
       ...
       children: <Widget>[
         ...
         isOpen ? Container() : promotionItem(),
       ],
     ),
   );
  }
            ...
            Container(
              ...
              TableRow(children: [
                Container(
                  ...
                  Container(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(children: [
                    Padding(
                      padding: const EdgeInsets.only(right: 122, top: 19),
                      child: RichText(
                        text: TextSpan(
                          children: <TextSpan>[
                            TextSpan(
                ...
                TableRow(children: [
                  ...
                  Column(children: [
                  Padding(
                    padding: EdgeInsets.only(right: 116, top: 15),
                    child: RichText(
                      text: TextSpan(
                        children: <TextSpan>[
                        TextSpan(
                ...
                Container(
                  ...
                  Container(
                    ...
                    child: SizedBox(
                      ...
                      child: Column(children: [
                    Padding(
                      padding: const EdgeInsets.only(right: 116, top: 19),
                        child: RichText(
                        text: TextSpan(
                      children: <TextSpan>[
                    TextSpan(
